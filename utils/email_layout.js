/**
 * Shared branded wrapper for transactional email bodies.
 * Mirrors the layout used by the original template seeder so newly added
 * templates stay visually consistent with the existing ones.
 */
